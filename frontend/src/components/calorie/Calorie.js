              ...
              <form onSubmit={onClickBtn}>
                ...
                <div className="relative">
                  <div className="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                    <svg aria-hidden="true" className="z-50 w-5 h-5 text-gray-500 dark:text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"></path></svg>
                  </div>
                  <input type="text" value={keyword} onChange={onChangeKeyword} className="block w-full p-4 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg focus:ring-green-700 focus:border-green-700 dark:border-gray-400 dark:placeholder-gray-400 dark:focus:ring-green-700 dark:focus:border-green-700" placeholder="검색어 입력" />
                  <button type="submit" className="text-white absolute right-2.5 bottom-2.5 bg-green-700 focus:ring-4 focus:outline-none focus:ring-blue-300 font-bold rounded-lg text-sm px-4 py-2 z-50 ">검색</button>
                </div>
              </form>
              {resultDiv && (
